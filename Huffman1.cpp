...
Node* Coder1()
{
	...
	//сжимаем текст
	ifstream fileIn("SourceCode.txt", ios::out | ios::binary);
	ofstream fileBinary("Binary1.txt", ios::out | ios::binary);
...
void Coder2()
{
	...
	table.clear();
	CreateTrees(m);
	Coding("SourceCode.txt", "Binary2.txt");
}
...
void Coder3()
{
	...
	table.clear();
	CreateTrees(matrix);
	Coding("SourceCode.txt", "Binary3.txt");
}
